...
export class SettingsManager {
    ...
    getApiKey(provider) {
        switch (provider) {
            ...
            case LLMProviders.DEEPSEEK:
                return this._settings.get_string(SettingsKeys.DEEPSEEK_API_KEY);
            default:
                return "";
        }
    }
    ...
    getModel(provider) {
        switch (provider) {
            ...
            case LLMProviders.DEEPSEEK:
                return this._settings.get_string(SettingsKeys.DEEPSEEK_MODEL);
            default:
                return "";
        }
    }
    ...
    setApiKey(provider, apiKey) {
        switch (provider) {
            ...
            case LLMProviders.OPENROUTER:
                ...
                break;
            case LLMProviders.DEEPSEEK:
                this._settings.set_string(SettingsKeys.DEEPSEEK_API_KEY, apiKey);
        }
    }
    ...
    setModel(provider, model) {
        switch (provider) {
            ...
            case LLMProviders.OPENROUTER:
                ...
                break;
            case LLMProviders.DEEPSEEK:
                this._settings.set_string(SettingsKeys.DEEPSEEK_MODEL, model);
        }
    }
